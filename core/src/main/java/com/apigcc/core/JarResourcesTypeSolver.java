    ...
    private void parseJarTotal() throws IOException {
        ...
        while (entries.hasMoreElements()) {
            ...
            if (jarEntry.getName().endsWith(".java")) {
                ...
                compilationUnit.ifPresent(value -> {
                    parsedFiles.put(srcJarPath + "/" + jarEntry.getName(), value);
                });
            } else {
                System.out.println("jarFileEntry:" + jarEntry.getName() + "notjavafile,willbeignore");
            }
        }
    }
