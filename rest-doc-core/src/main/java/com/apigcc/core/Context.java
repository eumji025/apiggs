...
import com.apigcc.core.handler.MarkdownTreeHandler;
...
public class Context {
    ...
    protected Collection<TreeHandler> pipeline = Lists.newArrayList(new PostmanTreeHandler(), new AsciidocTreeHandler(), new HtmlTreeHandler(),new MarkdownTreeHandler());
